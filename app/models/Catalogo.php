...
class Catalogo
{
	...
	private $notNullFields = "descricao, nome";
	...
	*/
	...
	{
		if ($this->getIdCatalogo() == 0) {
			throw new \Exception("Não é possível excluir - o catálogo não está salvo no banco de dados.");
		}

		$primaryKeyValues = [$this->getIdCatalogo()];

		try {
			return $this->dbquery->delete($primaryKeyValues);
