...
use core\database\Where;
	...
	private $fieldsName = "idProfissional, nome, cargo, hrTrabalho, cpf, cep, endereco, complemento, telefone, email";
	...
	function populate( $idProfissional, $nome, $cargo, $hrTrabalho, $cpf, $cep, $endereco, $complemento, $telefone, $email){
