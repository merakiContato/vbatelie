...
<body id="body">
    ...
    <div class="d-flex flex-column min-vh-100">
        ...
        <form id="newMaterial" class="formgeren row g-4 m-4">
            <div class="col-md-4">
                <label for="titulo" class="form-label mb-2">Título</label>
                <input type="text" class="form-control" id="titulo" name="titulo" required placeholder="Insira o título do material">
            </div>
            <div class="col-md-4">
                <label for="descricao" class="form-label mb-2">Descrição</label>
                <input type="text" class="form-control" id="descricao" name="descricao" required placeholder="Insira a descrição do material">
            </div>
            <div class="col-12">
                    ...
                    $.each(data, function(i, material) {
                        ...
                        $.each(labelsDataTable, function(i, label) {
                            tableHtml += '<td class="td-centered">' +
                                '<input type="text" class="form-control input-large" name="' + labelsMaterial[i] + '" form="' + formId + '" value="' + (material[label] || '') + '" >'
